...
var Balloon = (function (_React$Component) {
  ...
  Balloon.prototype.render = function render() {
    ...
    var visibility = '' + prefix + this.state.visibility;
    var shadow = prefix + 'shadow';
    var position = prefix + 'position-' + this.props.balloonPosition;
    var balloonContentClassname = this.props.unstyled ? 'content' : 'balloon-content';
    var triangleShouldDisplay = this.state.visibility === 'visible' && !this.props.unstyled;
    return _react2['default'].createElement(
      'div',
      { ref: 'balloon', className: _classnames4['default'](position, visibility, (_classnames = { balloon: !this.props.unstyled }, _classnames[this.props.className] = this.props.className, _classnames)) },
      triangleShouldDisplay && _react2['default'].createElement('div', { className: 'balloon__triangle' }),
      ...
      _react2['default'].createElement(
        ...
        _extends({
          ref: 'balloonContent',
          className: _classnames4['default'](balloonContentClassname, (_classnames2 = {}, _classnames2[shadow] = this.props.shadow, _classnames2)),
